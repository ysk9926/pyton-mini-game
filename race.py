...
t.speed(0)
t.goto(0, 220)
t.write("Race Game", False, "center", font=("Arial", 35, "normal"))
...
t.goto(0, -350)
t.color("black")
t.write(f"your batting {user_choice}th ball", False, "center", font=("Arial", 30, "normal"))
...
if user_choice == winner:
    t.write("You Win", False, "center", font=("Arial", 35, "normal"))
else:
    t.write(f"Lose winner is {winner} ", False, "center", font=("Arial", 35, "normal"))
